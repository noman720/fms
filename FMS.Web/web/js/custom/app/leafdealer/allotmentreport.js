...
{
    showDialog();
    var value = "actionType=getFarmerAllotmentReport";
    $.ajax({
            cache     : false,
            type      : "post",
            data      : value,
            ...
            success   :	function(response){
                ...
                for(var i = 0; i<response.length; i++)
                {
                    ...
                    rows += "<tr><td align=\"left\">"+farmerId+"</td><td align=\"left\">"+year+"</td><td align=\"center\">"+seasionName+"</td><td align=\"center\">"+fertilizerName+"</td><td align=\"center\">"+allotmentAount+"</td><td align=\"center\">"+transactedAmount+"</td></tr>";
                }
