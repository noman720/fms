...
function showAllotmentReport()
{
    showDialog();
    var value = "actionType=getDealerAllotmentReport";
    $.ajax({
            cache     : false,
            type      : "post",
            data      : value,
            ...
            success   :	function(response){
                ...
                for(var i = 0; i<response.length; i++)
                {
                    ...
                    var dealerId = fertilizerAppBean["dealerId"];
                    ...
                    var allotmentAount = fertilizerAppBean["totalAllotedAmount"]+" ("+fertilizerAppBean["totalAllotedAmountUnit"]+")";
                    var transactedAmount = fertilizerAppBean["totalTransactedAmount"]+" ("+fertilizerAppBean["totalTransactedAmountUnit"]+")";
                    rows += "<tr><td align=\"left\">"+dealerId+"</td><td align=\"left\">"+year+"</td><td align=\"center\">"+seasionName+"</td><td align=\"center\">"+fertilizerName+"</td><td align=\"center\">"+allotmentAount+"</td><td align=\"center\">"+transactedAmount+"</td></tr>";
                }
