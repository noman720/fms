    ...
    function saveTransaction()
    {
        ...
        var value = "actionType=saveTransaction&saveTransactionJson="+json;
        $.ajax({
            cache     : false,
            type      : "post",
            data      : value,
...
//        }
    ...
    {
        var value = "actionType=getTransactionToolbar";
        $.ajax({
            cache     : false,
            type      : "post",
            data      : value,
...
//        var cropsName = $("#cmbCropsName").val().trim();
        ...
        var value = "actionType=getAllotedValue&seasionYear="+seasionYear+"&seasionName="+seasionName+"&fertiName="+fertiName;
        $.ajax({
            cache     : false,           
            type      : "post",
            data      : value,
    ...
    {
        //alert(response.totalAllotedAmount);
