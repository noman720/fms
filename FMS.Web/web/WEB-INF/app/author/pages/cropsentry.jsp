...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/custom/app/author/cropsentry.css" />
        ...
        <script type="text/javascript" src="js/custom/app/author/cropsentry.js"></script>
    ...
    <body>
        ...
        <center>
        <div id="cropsEntry" class="cropsEntry">
            
            <div>
                <span class="reportheading">Crops Entry</span>
                </br></br>

            </div>
            <div>
                <table id="cropsEntryTable">
                    <tr>
                        <td><label>Crops ID<span style="color: red;">*</span></label></td>
                        <td style="width: 20px;">&nbsp;</td>
                        <td><input type="text" id="txtCropsId" class="txtCropsId" value=""/></td>
                    </tr>
                    <tr>
                        <td><label>Crops Name<span style="color: red;">*</span></label></td>
                        <td style="width: 20px;">&nbsp;</td>
                        <td><input type="text" id="txtCropsName" class="txtCropsName" value=""/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td style="width: 20px;">&nbsp;</td>
                        <td style="padding-left: 16px;padding-top: 12px;"><input type="button" id="btnSubmitSave" class="btn btn-primary btn-large" value="Save" onclick="saveCrops();" /></td>
                    </tr>
                </table>
            </div>
            <br/>
            ...
            <div style="width: 100%">
            <table id="cropsTable" class="cropsTable">
                <thead>
                  <tr>
                      <th>Crops ID</th>
                      <th>Crops Name </th>
                ...
                <tfoot>
                    <tr>
                        <th align="center" colspan="3"><b>Total : </b> <span id="totalCropsValue"></span></th>
                    </tr>
                </tfoot>
            </table>
            </div>
