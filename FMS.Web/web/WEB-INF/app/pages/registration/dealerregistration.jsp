...
<html>
    ...
    <center>
        ...
        <table border="0" class="dealerregistrationform">
            ...
            <tr>
                <td><label>Parent Dealer ID<span style="color: red;">*</span></label></td>
                <td style="width: 20px;">&nbsp;</td>
                <td><input type="text" id="txtParentId" class="txtParentId" value=""/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 20px;">&nbsp;</td>
                <td><input type="text" id="txtBirthDate" class="txtBirthDate" value=""/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td style="width: 20px;">&nbsp;</td>
                <td style="padding-left: 16px;padding-top: 12px;"><input type="button" id="btnSubmitSave" class="btn btn-primary btn-large" value="Save" onclick="saveDealer()" /></td>
            </tr>
        </table>
    </center>
