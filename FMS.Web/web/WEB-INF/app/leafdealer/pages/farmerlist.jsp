...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/custom/app/leafdealer/showfarmerlist.css" />
        ...
        <script type="text/javascript" src="js/custom/app/leafdealer/farmerlist.js"></script>
    ...
    <body>
        ...
        <center>
        <div id="farmerList" class="farmerList">
            ...
            <br/>
            <div style="width: 90%">
            <table id="farmertable" class="farmertable">
                <thead>
                  <tr>
                      <th>ID</th>
                      <th>National ID </th>
