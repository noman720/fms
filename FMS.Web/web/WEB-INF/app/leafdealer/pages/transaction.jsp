...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/custom/app/leafdealer/transaction.css" />
        ...
        <script type="text/javascript" src="js/custom/app/leafdealer/transaction.js"></script>
        ...
        <table border="0" class="transactiontoolbartable" id="transactiontoolbartable">
            <tr>
                ...
                <td colspan="2" style="padding-left: 15px;">
                    <select id="cmbFarmerId" class="cmbFarmerId" style="width:220px;" tabindex="7">
...
<!--            <tr>
                ...
                <td style="width: 20px;">&nbsp;</td>
                <td colspan="2" style="padding-left: 15px;">
                    <select id="cmbCropsName" class="cmbCropsName" style="width:220px;" tabindex="7"></select>
                </td>
